...
\section{Data Analysis}
    ...
    \subsection{A team using a CD pipeline will refine their scope more often}
        Statistically significant chance, around 97\%, that the difference observed is not from random chance. The size of this observed difference is also large, with an effect size of 0.16.
