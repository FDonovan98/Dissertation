...
\section{Data Analysis}
    ...
    \subsection*{The Results For Each Hypothesis}
        ...
        \subsection{A CD pipeline will help developers understand the current state of the project}
            Pr($>$F) of 0.68, so there is a ~68\% chance that the observed effect could be from random chance, which is not statistically significant. The statistical power of this result was -0.04.
