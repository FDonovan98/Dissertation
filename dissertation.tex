...
Once data has been collected, it can be parsed using a python script and then analysed in R. Below is an excerpt of sample code that can be used, produced using these guides as reference\cite{Rtutone,Rtuttwo}.
