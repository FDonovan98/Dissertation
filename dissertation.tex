...
\section{Background \& Supporting Literature}
    What is CD \cite{ContDelIntro,bamboo}? Best practices\cite{duvall2007continuous}? Has this been done before in academic setting\cite{CDCourse2014,CDMobileDev,Tornado}? What benefits is it supposed to have\cite{ContDelIntro}? Drawbacks\cite{ContDelChall}? Links to other things - CI\cite{CICDCD}, Unit tests, regular product reviews, stakeholder (supervisor) confidence, git flow \cite{gitBranching}
