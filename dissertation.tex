...
\section{Background \& Supporting Literature}
    What is CD \cite{ContDelIntro,bamboo}? Has this been done before\cite{CDCourse2014,CDMobileDev,Tornado}? What benefits is it supposed to have\cite{ContDelIntro}? Drawbacks\cite{ContDelChall}? Links to other things - CI, Unit tests, regular product reviews, stakeholder (supervisor) confidence
