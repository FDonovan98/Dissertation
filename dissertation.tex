...
Once data has been collected, it can be parsed using a python script and then analysed in R. Below is an excerpt of sample code in R that can be used ot conduct a one way ANOVA test on results loaded in from a csv file. This has been produced using the cited guides as reference\cite{Rtutone,Rtuttwo}.
